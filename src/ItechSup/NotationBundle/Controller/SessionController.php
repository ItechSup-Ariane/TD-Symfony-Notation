...
use ItechSup\NotationBundle\Entity\Session;
use ItechSup\NotationBundle\Form\SessionType;
...
class SessionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $sessions = $em->getRepository('ItechSupNotationBundle:Session')->findAll();
    ...
    {
        $session = new Session();
        $form = $this->createForm('ItechSup\NotationBundle\Form\SessionType', $session);
    ...
    {
        $deleteForm = $this->createDeleteForm($session);
        $editForm = $this->createForm('ItechSup\NotationBundle\Form\SessionType', $session);

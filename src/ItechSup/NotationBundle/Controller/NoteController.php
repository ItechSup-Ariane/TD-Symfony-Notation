...
use ItechSup\NotationBundle\Entity\Note;
use ItechSup\NotationBundle\Form\NoteType;
...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notes = $em->getRepository('ItechSupNotationBundle:Note')->findAll();
    ...
    {
        $note = new Note();
        $form = $this->createForm('ItechSup\NotationBundle\Form\NoteType', $note);
    ...
    {
        $deleteForm = $this->createDeleteForm($note);
        $editForm = $this->createForm('ItechSup\NotationBundle\Form\NoteType', $note);
